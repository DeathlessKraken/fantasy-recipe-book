        ...
        <nav className="">
          <div className="grid grid-flow-col gap-4">
            ...
            <a href="https://www.linkedin.com/in/sean-brown-a98a512b3/">
              <svg viewBox="0 0 128 128" width='24' height='24' className="fill-current">
                <path d="M116 3H12a8.91 8.91 0 00-9 8.8v104.42a8.91 8.91 0 009 8.78h104a8.93 8.93 0 009-8.81V11.77A8.93 8.93 0 00116 3z"></path><path fill="rgb(253 186 116 / var(--tw-bg-opacity))" d="M21.06 48.73h18.11V107H21.06zm9.06-29a10.5 10.5 0 11-10.5 10.49 10.5 10.5 0 0110.5-10.49M50.53 48.73h17.36v8h.24c2.42-4.58 8.32-9.41 17.13-9.41C103.6 47.28 107 59.35 107 75v32H88.89V78.65c0-6.75-.12-15.44-9.41-15.44s-10.87 7.36-10.87 15V107H50.53z"></path>
              </svg>
            </a>
            <a href="https://stackoverflow.com/users/3557315/">
              <svg viewBox="0 0 128 128" width='24' height='24' className="fill-current">
                <path d="M101.072 82.51h11.378V128H10.05V82.51h11.377v34.117h79.644zm0 0"></path><path d="m33.826 79.13 55.88 11.738 2.348-11.166-55.876-11.745Zm7.394-26.748 51.765 24.1 4.824-10.349-51.768-24.1Zm14.324-25.384L99.428 63.53l7.309-8.775-43.885-36.527ZM83.874 0l-9.167 6.81 34.08 45.802 9.163-6.81Zm-51.07 105.254h56.89V93.881h-56.89Zm0 0"></path>
              </svg>
            </a>
          </div>
        </nav>
        <aside>
          <p>Copyright © {currentYear} - Designed by Sean Brown</p>
        </aside>
      </footer>
    );
}